...
public class MySqlDebeziumDeserializer_Tuple2 implements DebeziumDeserializationSchema, MySqlDeserialization {
    ...
    public MySqlDebeziumDeserializer_Tuple2(Map tableRowTypeMap) {
        this.tableRowTypeMap = tableRowTypeMap;
        init();
    }

    public MySqlDebeziumDeserializer_Tuple2() {
