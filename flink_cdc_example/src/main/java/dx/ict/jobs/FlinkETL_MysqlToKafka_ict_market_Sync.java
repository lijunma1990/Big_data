 ...
 * @Version 1.0
 */
public class FlinkETL_MysqlToKafka_ict_market_Sync {
    /**
     * flink cdc Mysql整库同步
     */


    private static final Logger log = LoggerFactory.getLogger(FlinkETL_MysqlToKafka_ict_market_Sync.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.execute("FlinkETL_MysqlToKafka_ict_market_Sync");
    }
}
