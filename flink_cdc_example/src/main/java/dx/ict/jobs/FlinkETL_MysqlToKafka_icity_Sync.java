 ...
 * @Version 1.0
 */
public class FlinkETL_MysqlToKafka_icity_Sync {
    /**
     * flink cdc Mysql整库同步
     */


    private static final Logger log = LoggerFactory.getLogger(FlinkETL_MysqlToKafka_icity_Sync.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        mysqlSourceMap.add_source(
                ...
                passWord,
                "",
                "MySqlDeserializationSchema_Tuple5");//插入Mysql连接配置source（name:mysql_source->tableList）
        ...
        env.execute("FlinkETL_MysqlToKafka_icity_Sync");
    }
}
